...
describe('AggregatorController', () => {
  ...
  describe('getAllProducts', () => {
    ...
    it('should apply price range filter', async () => {
      const minPrice = 50;
      const maxPrice = 150;
      const result = await controller.getAllProducts(undefined, minPrice, maxPrice);
    ...
    it('should apply availability filter', async () => {
      ...
      const result = await controller.getAllProducts(undefined, undefined, undefined, availability);
    ...
    it('should apply provider filter', async () => {
      ...
      const result = await controller.getAllProducts(undefined, undefined, undefined, undefined, provider);
    ...
    it('should apply all filters', async () => {
      ...
      const availability = true;
      const provider = 'provider-one';
      const result = await controller.getAllProducts(name, minPrice, maxPrice, availability, provider);
